(() => {
  ...
  var X = (t, e, r) =>
      e in t
        ? z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r })
        : (t[e] = r),
    Z = (t, e) => {
      for (var r in e || (e = {})) J.call(e, r) && X(t, r, e[r]);
      if (G) for (var r of G(e)) xe.call(e, r) && X(t, r, e[r]);
      return t;
    };
  var Se = t => z(t, "__esModule", { value: !0 });
      ...
      if ((e && typeof e == "object") || typeof e == "function")
        for (let n of me(e))
          !J.call(t, n) &&
            ...
            z(t, n, {
              get: () => e[n],
              enumerable: !(r = ye(e, n)) || r.enumerable
            });
      return t;
    },
    W = t =>
...
`,
        ...
        var e = {
          ...
          M = function(l) {
            ...
            if (
              ...
              var S = d.exec(l);
              (d = y), d.test(S[1]) && ((d = w), (l = l.replace(d, "")));
            } else if (x.test(l)) {
              var S = x.exec(l);
              (m = S[1]),
                (x = v),
            ...
            if (((d = A), d.test(l))) {
              var S = d.exec(l);
              (m = S[1]), (I = S[2]), (d = y), d.test(m) && (l = m + e[I]);
            }
            if (((d = $), d.test(l))) {
              var S = d.exec(l);
              (m = S[1]), (I = S[2]), (d = y), d.test(m) && (l = m + r[I]);
            }
            if (((d = D), (x = V), d.test(l))) {
              var S = d.exec(l);
              (m = S[1]), (d = g), d.test(m) && (l = m);
            } else if (x.test(l)) {
              var S = x.exec(l);
              (m = S[1] + S[2]), (x = g), x.test(m) && (l = m);
            }
            if (((d = P), d.test(l))) {
              var S = d.exec(l);
              (m = S[1]),
                ...
                (x = b),
                (R = B),
                (d.test(m) || (x.test(m) && !R.test(m))) && (l = m);
            }
            return (
              (d = N),
              (x = g),
              d.test(l) && x.test(l) && ((d = w), (l = l.replace(d, ""))),
              ...
              for (var h = s[c], y = 0; y < u; y++) {
                ...
                if (g == h || h == "*") {
                  var b = n.node.edges[g],
                    ...
                    f = void 0;
                  g in n.output.edges
                    ? ((f = n.output.edges[g]), (f.final = f.final || Q))
                    : ((f = new t.TokenSet()),
                      (f.final = Q),
                      (n.output.edges[g] = f)),
       ...
       */ (t.Index = function(e) {
        ...
        (t.Index.prototype.query = function(e) {
          ...
          for (var u = 0; u < r.clauses.length; u++) {
            ...
            for (var g = 0; g < h.length; g++) {
              ...
              var v = t.TokenSet.fromClause(c),
                Q = this.tokenSet.intersect(v).toArray();
              ...
              for (var L = 0; L < Q.length; L++)
                for (
                  var w = Q[L], k = this.invertedIndex[w], O = k._index, f = 0;
                  f < c.fields.length;
                  f++
                ) {
                  var p = c.fields[f],
                  ...
                  if (
                    (i[p].upsert(O, c.boost, function(fe, pe) {
                      return fe + pe;
                    }),
                    !s[A])
                  ) {
                    for (var D = 0; D < C.length; D++) {
                      var V = C[D],
                        P = new t.FieldRef(V, p),
                        N = j[V],
                        B;
                      (B = n[P]) === void 0
                        ? (n[P] = new t.MatchData(w, p, N))
                        : B.add(w, p, N);
                    }
                    s[A] = !0;
                  }
          ...
          for (
            var M = t.Set.complete, _ = t.Set.empty, u = 0;
            u < this.fields.length;
            u++
          ) {
            var p = this.fields[u];
            o[p] && (M = M.intersect(o[p])), a[p] && (_ = _.union(a[p]));
          }
          var l = Object.keys(n),
            m = [],
            I = Object.create(null);
          ...
          for (var u = 0; u < l.length; u++) {
            var E = t.FieldRef.fromString(l[u]),
              d = E.docRef;
            if (!!M.contains(d) && !_.contains(d)) {
              var x = this.fieldVectors[E],
                R = i[E.fieldName].similarity(x),
                F;
              if ((F = I[d]) !== void 0)
                (F.score += R), F.matchData.combine(n[E]);
              else {
                var S = { ref: d, score: R, matchData: n[E] };
                (I[d] = S), m.push(S);
              }
            }
          }
          return m.sort(function(he, de) {
            return de.score - he.score;
          });
        }),
            ...
            for (var b = 0; b < h.length; b++) {
              ...
              if (
                ...
                for (var f = 0; f < i.length; f++)
                  Q[i[f]] = Object.create(null);
                this.invertedIndex[v] = Q;
              }
              this.invertedIndex[v][o][n] == null &&
                (this.invertedIndex[v][o][n] = Object.create(null));
              for (var p = 0; p < this.metadataWhitelist.length; p++) {
                var L = this.metadataWhitelist[p],
                  w = v.metadata[L];
                this.invertedIndex[v][o][n][L] == null &&
                  (this.invertedIndex[v][o][n][L] = []),
                  this.invertedIndex[v][o][n][L].push(w);
              }
            }
          }
        }),
  ...
  function se(t) {
    ...
    for (let n of t) {
      let [i, s] = n.location.split("#"),
        o = n.location,
        a = n.title,
        u = (0, ie.default)(n.text)
          .replace(/\s+(?=[,.:;!?])/g, "")
          .replace(/\s+/g, " ");
      if (s) {
        let c = e.get(i);
        r.has(c)
          ? e.set(o, { location: o, title: a, text: u, parent: c })
          : ((c.title = n.title), (c.text = u), r.add(c));
      } else e.set(o, { location: o, title: a, text: u });
    }
    return e;
  }
  var oe = W(H());
  ...
  function ce(t, e) {
    ...
    for (let i = 0; i < e.length; i++)
      for (let s of r)
        e[i].startsWith(s.term) && ((n[s.term] = !0), r.delete(s));
    for (let i of r) n[i.term] = !1;
    return n;
  }
  function Le(t, e) {
  ...
  var q = class {
    constructor({ config: e, docs: r, index: n, options: i }) {
      (this.options = i),
        (this.documents = se(r)),
        ...
        typeof n == "undefined"
          ? (this.index = lunr(function() {
              ...
              let s = Le(["trimmer", "stopWordFilter", "stemmer"], i.pipeline);
              ...
              this.ref("location"),
                ...
                this.field("text");
              for (let o of r) this.add(o);
            }))
          : (this.index = lunr.Index.load(n));
    }
    search(e) {
      if (e)
        try {
            ...
            i = this.index
              ...
              .reduce((o, { ref: a, score: u, matchData: c }) => {
                ...
                if (typeof h != "undefined") {
                  let { location: y, title: g, text: b, parent: v } = h,
                    Q = ce(n, Object.keys(c.metadata)),
                    f = +!v + +Object.values(Q).every(p => p);
                  o.push({
                    location: y,
                    title: r(g),
                    text: r(b),
  ...
  function ke(t) {
    return U(this, null, function*() {
      switch (t.type) {
        case T.SETUP:
          return (
            yield Ee(t.data.config), (Y = new q(t.data)), { type: T.READY }
          );
        case T.QUERY:
          return { type: T.RESULT, data: Y ? Y.search(t.data) : { items: [] } };
        default:
  ...
  addEventListener("message", t =>
    U(void 0, null, function*() {
      postMessage(yield ke(t.data));
    })
  );
})();
//# sourceMappingURL=search.8397ff9e.min.js.map
