...
(() => {
  ...
  var Z = Math.pow,
    ...
    A = (t, e) => {
      ...
      if (Y) for (var r of Y(e)) Ee.call(e, r) && J(t, r, e[r]);
      return t;
    },
    q = (t, e) => xe(t, Se(e));
  var be = (t, e) => () => (
    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of Te(e))
        !X.call(t, i) &&
          ...
          U(t, i, {
            get: () => e[i],
            enumerable: !(n = ve(e, i)) || n.enumerable
          });
    return t;
  };
  var we = (t, e, r) => (
    ...
    Le(
      e || !t || !t.__esModule
        ? U(r, "default", { value: t, enumerable: !0 })
        : r,
      t
    )
  );
       ...
       */ (t.tokenizer = function(e, r) {
        ...
        if (Array.isArray(e))
          return e.map(function(g) {
            return new t.Token(
              t.utils.asString(g).toLowerCase(),
              t.utils.clone(r)
            );
          });
        for (
          ...
          if (c.match(t.tokenizer.separator) || o == i) {
            if (u > 0) {
              var l = t.utils.clone(r) || {};
              (l.position = [a, u]),
                (l.index = s.length),
                s.push(new t.Token(n.slice(a, o), l));
            }
            a = o + 1;
          }
        }
...
`,
       ...
       */ (t.stemmer = (function() {
        var e = {
          ...
          M = function(h) {
            ...
            if (((p = C), (T = V), p.test(h))) {
              var Q = p.exec(h);
              (S = Q[1]), (p = f), p.test(S) && (h = S);
            } else if (T.test(h)) {
              var Q = T.exec(h);
              (S = Q[1] + Q[2]), (T = f), T.test(S) && (h = S);
            }
            if (((p = P), p.test(h))) {
              var Q = p.exec(h);
              (S = Q[1]),
            ...
            return (
              (p = z),
              (T = f),
              p.test(h) && T.test(h) && ((p = E), (h = h.replace(p, ""))),
        ...
        (t.TokenSet.fromFuzzyString = function(e, r) {
          for (
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length > 1) {
                var l = s.str.charAt(0),
                  g = s.str.charAt(1),
                  f;
                g in s.node.edges
                  ? (f = s.node.edges[g])
                  : ((f = new t.TokenSet()), (s.node.edges[g] = f)),
        ...
        (t.TokenSet.prototype.intersect = function(e) {
          for (
            ...
            for (
              ...
              for (var l = s[u], g = 0; g < c; g++) {
                var f = a[g];
                if (f == l || l == "*") {
                  var v = n.node.edges[f],
                    m = n.qNode.edges[l],
                    x = v.final && m.final,
                    d = void 0;
                  f in n.output.edges
                    ? ((d = n.output.edges[f]), (d.final = d.final || x))
                    : ((d = new t.TokenSet()),
                      (d.final = x),
                      (n.output.edges[f] = d)),
                    i.push({ qNode: m, output: d, node: v });
                }
              }
          }
          return r;
        ...
        (t.Index.prototype.query = function(e) {
          ...
          for (var c = 0; c < r.clauses.length; c++) {
            var u = r.clauses[c],
              ...
              g = t.Set.empty;
            u.usePipeline
              ? (l = this.pipeline.runString(u.term, { fields: u.fields }))
              : (l = [u.term]);
            for (var f = 0; f < l.length; f++) {
              var v = l[f];
              u.term = v;
              var m = t.TokenSet.fromClause(u),
                x = this.tokenSet.intersect(m).toArray();
              if (x.length === 0 && u.presence === t.Query.presence.REQUIRED) {
                for (var d = 0; d < u.fields.length; d++) {
                  var y = u.fields[d];
                  o[y] = t.Set.empty;
                }
                break;
              ...
              for (var b = 0; b < x.length; b++)
                for (
                  var E = x[b], w = this.invertedIndex[E], R = w._index, d = 0;
                  d < u.fields.length;
                  d++
                ) {
                  var y = u.fields[d],
                  ...
                  if (
                    (i[y].upsert(R, u.boost, function(ge, ye) {
                      return ge + ye;
                    }),
                    !s[D])
                  ) {
                    for (var C = 0; C < _.length; C++) {
                      var V = _[C],
                        P = new t.FieldRef(V, y),
                        z = j[V],
                        $;
                      ($ = n[P]) === void 0
                        ? (n[P] = new t.MatchData(E, y, z))
                        : $.add(E, y, z);
                    }
                    s[D] = !0;
                  }
          ...
          for (
            var M = t.Set.complete, I = t.Set.empty, c = 0;
            c < this.fields.length;
            c++
          ) {
            var y = this.fields[c];
          ...
          for (var c = 0; c < h.length; c++) {
            var L = t.FieldRef.fromString(h[c]),
              p = L.docRef;
            if (M.contains(p) && !I.contains(p)) {
              var T = this.fieldVectors[L],
                O = i[L.fieldName].similarity(T),
                F;
              if ((F = k[p]) !== void 0)
                (F.score += O), F.matchData.combine(n[L]);
              else {
        ...
        (t.Builder.prototype.add = function(e, r) {
          ...
          for (var s = 0; s < i.length; s++) {
            var o = i[s],
              ...
              c = a ? a(e) : e[o],
              u = this.tokenizer(c, { fields: [o] }),
              l = this.pipeline.run(u),
              g = new t.FieldRef(n, o),
              f = Object.create(null);
            (this.fieldTermFrequencies[g] = f),
              (this.fieldLengths[g] = 0),
              (this.fieldLengths[g] += l.length);
            for (var v = 0; v < l.length; v++) {
              ...
              if (
                ...
                for (var d = 0; d < i.length; d++)
                  x[i[d]] = Object.create(null);
                this.invertedIndex[m] = x;
              }
              ...
              for (var y = 0; y < this.metadataWhitelist.length; y++) {
                var b = this.metadataWhitelist[y],
                  E = m.metadata[b];
                this.invertedIndex[m][o][n][b] == null &&
                  (this.invertedIndex[m][o][n][b] = []),
                  this.invertedIndex[m][o][n][b].push(E);
              }
            }
          }
        }),
        ...
        (t.Builder.prototype.createFieldVectors = function() {
          for (
            ...
            for (
              ...
              var d = g[x],
                y = l[d],
                b = this.invertedIndex[d]._index,
                E,
                w,
                R;
              i[d] === void 0
                ? ((E = t.idf(this.invertedIndex[d], this.documentCount)),
                  (i[d] = E))
                : (E = i[d]),
                (w =
                  (E * ((this._k1 + 1) * y)) /
          ...
          for (var r = Object.keys(e.metadata), n = 0; n < r.length; n++) {
            ...
            for (var o = 0; o < s.length; o++) {
              ...
              for (var u = 0; u < c.length; u++) {
                var l = c[u];
                this.metadata[i][a][l] == null
                  ? (this.metadata[i][a][l] = e.metadata[i][a][l])
                  : (this.metadata[i][a][l] = this.metadata[i][a][l].concat(
                      e.metadata[i][a][l]
                    ));
              }
            }
  ...
  function G(t, e, r) {
    ...
    for (let i = 1; i < e.length; i++) {
      let s = e[i - 1],
        o = e[i],
        a = (s[s.length - 1] >>> 2) & 1023,
        c = o[0] >>> 12;
      n.push(+(a > c) + n[n.length - 1]);
    }
    return t.map((i, s) => {
      let o = new Map();
      for (let c of r.sort((u, l) => u - l)) {
        let u = c & 1048575,
          l = c >>> 20;
        if (n[l] !== s) continue;
        let g = o.get(l);
        typeof g == "undefined" && o.set(l, (g = [])), g.push(u);
      }
  ...
  function oe(t) {
    ...
    for (let n = 0; n < r.length; n++) {
      ...
      ie(r[n], (o, a, c, u) => {
        var l;
        switch ((i[(l = o += s)] || (i[l] = []), a)) {
          case 0:
          case 2:
            i[o].push((c << 12) | ((u - c) << 2) | a);
            break;
          case 1:
            let g = r[n].slice(c, u);
            W(g, lunr.tokenizer.separator, (f, v) => {
              if (typeof lunr.segmenter != "undefined") {
                let m = g.slice(f, v);
                if (/^[MHIK]$/.test(lunr.segmenter.ctype_(m))) {
                  let x = lunr.segmenter.segment(m);
                  for (let d = 0, y = 0; d < x.length; d++)
                    i[o] || (i[o] = []),
                      i[o].push(((c + f + y) << 12) | (x[d].length << 2) | a),
                      e.push(
                        new lunr.Token(x[d].toLowerCase(), {
              ...
              i[o].push(((c + f) << 12) | ((v - f) << 2) | a),
                e.push(
                  new lunr.Token(g.slice(f, v).toLowerCase(), {
                    position: (o << 20) | (i[o].length - 1)
                  })
                );
            });
  ...
  function ue(t) {
    return ae(t, e => {
      ...
      for (let { type: i, str: s, start: o, end: a } of n.lexemes)
        i === "TERM" &&
          W(s, lunr.tokenizer.separator, (...c) => {
            r.push([e.slice(0, o), s.slice(...c), e.slice(a)].join(""));
          });
      return r;
    });
  }
  function ce(t) {
    ...
    for (let n of e.clauses)
      (n.usePipeline = !0),
        n.term.startsWith("*") &&
          ((n.wildcard = lunr.Query.wildcard.LEADING),
          (n.term = n.term.slice(1))),
        n.term.endsWith("*") &&
          ((n.wildcard = lunr.Query.wildcard.TRAILING),
      ...
      (this.map = ne(r)),
        ...
        (this.index = lunr(function() {
          (this.metadataWhitelist = ["position"]),
            ...
            (lunr.segmenter =
              "TinySegmenter" in lunr ? new lunr.TinySegmenter() : void 0);
          let s = Oe(["trimmer", "stopWordFilter", "stemmer"], e.pipeline);
          for (let o of e.lang.map(a => (a === "en" ? lunr : lunr[a])))
            for (let a of s)
              this.pipeline.remove(o[a]), this.searchPipeline.remove(o[a]);
          this.ref("location"),
            this.field("title", { boost: 1e3, extractor: i("title") }),
            this.field("text", { boost: 1, extractor: i("text") }),
            this.field("tags", { boost: 1e6, extractor: i("tags") });
          for (let o of r) this.add(o, { boost: o.boost });
        }));
    }
    search(e) {
      if (((e = ue(e)), !e)) return { items: [] };
      let r = ce(e).filter(s => s.presence !== lunr.Query.presence.PROHIBITED),
        n = this.index
          .search(e)
          .reduce((s, { ref: o, score: a, matchData: c }) => {
            let u = this.map.get(o);
            if (typeof u != "undefined") {
              (u = A({}, u)), u.tags && (u.tags = [...u.tags]);
              let l = le(r, Object.keys(c.metadata));
              for (let f of this.index.fields) {
                if (typeof u[f] == "undefined") continue;
                let v = [];
                for (let d of Object.values(c.metadata))
                  typeof d[f] != "undefined" && v.push(...d[f].position);
                if (!v.length) continue;
                let m = this.table.get([u.location, f].join(":")),
                  x = Array.isArray(u[f]) ? G : se;
                u[f] = x(u[f], m, v);
              }
              let g =
                +!u.parent +
                Object.values(l).filter(f => f).length / Object.keys(l).length;
              s.push(q(A({}, u), { score: a * (1 + Z(g, 2)), terms: l }));
            }
            return s;
          }, [])
          .sort((s, o) => o.score - s.score)
          .reduce((s, o) => {
            let a = this.map.get(o.location);
            if (typeof a != "undefined") {
              let c = a.parent ? a.parent.location : a.location;
              s.set(c, [...(s.get(c) || []), o]);
            }
            return s;
          }, new Map());
  ...
  function Ie(t) {
    return B(this, null, function*() {
      switch (t.type) {
        case 0:
          return yield Re(t.data.config), (he = new H(t.data)), { type: 1 };
        case 2:
          let e = t.data;
          try {
            return { type: 3, data: he.search(e) };
          } catch (r) {
            return (
              console.warn(
                `Invalid query: ${e} \u2013 see https://bit.ly/2s3ChXG`
              ),
              console.warn(r),
              { type: 3, data: { items: [] } }
            );
