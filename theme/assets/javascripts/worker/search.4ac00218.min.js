!(function(e) {
  ...
  function(e, t, r) {
    ...
    e.exports = function(e) {
      ...
      for (o = i.index; o < r.length; o++) {
        ...
        a !== o && (s += r.substring(a, o)), (a = o + 1), (s += t);
      }
      return a !== o ? s + r.substring(a, o) : s;
    };
  },
  function(e, t, r) {
    var n = r(2),
      i = r(3);
    void 0 === i.lunr && (i.lunr = n), (e.exports = n);
  },
  function(e, t, r) {
    var n, i;
    /**
     ...
     */ !(function() {
      ...
      (I.version = "2.3.9"),
          ...
          for (
            ...
            if (r.charAt(s).match(I.tokenizer.separator) || s == n) {
              if (a > 0) {
                ...
                (u.position = [o, a]),
                  (u.index = i.length),
                  i.push(new I.Token(r.slice(o, s), u));
              }
              o = s + 1;
            }
          }
         ...
         */ (I.stemmer =
          ...
          (R = function(e) {
            ...
            if (
              ...
              var R = i.exec(e);
              (i = c).test(R[1]) && ((i = x), (e = e.replace(i, "")));
            } else
              s.test(e) &&
                ((t = (R = s.exec(e))[1]),
                (s = f).test(t) &&
            ...
            return (
              ...
              (s = L),
              (i = E).test(e)
                ? ((t = (R = i.exec(e))[1]), (i = h).test(t) && (e = t))
                : s.test(e) &&
                  ((t = (R = s.exec(e))[1] + R[2]), (s = h).test(t) && (e = t)),
              (i = P).test(e) &&
                ((t = (R = i.exec(e))[1]),
                (s = d),
                (u = O),
              ...
              (s = h),
              (i = T).test(e) && s.test(e) && ((i = x), (e = e.replace(i, ""))),
        ...
        (I.TokenSet.fromArray = function(e) {
          for (
            var t = new I.TokenSet.Builder(), r = 0, n = e.length;
            r < n;
            r++
          )
            t.insert(e[r]);
        ...
        (I.TokenSet.fromFuzzyString = function(e, t) {
          for (
            ...
            if (i.str.length > 0) {
              ...
              o in i.node.edges
                ? (s = i.node.edges[o])
                : ((s = new I.TokenSet()), (i.node.edges[o] = s)),
            ...
            if (0 != i.editsRemaining) {
              ...
              if (i.str.length > 1) {
                ...
                h in i.node.edges
                  ? (l = i.node.edges[h])
                  : ((l = new I.TokenSet()), (i.node.edges[h] = l)),
        ...
        (I.TokenSet.fromString = function(e) {
          for (
            var t = new I.TokenSet(), r = t, n = 0, i = e.length;
            n < i;
            n++
          ) {
            var s = e[n],
        ...
        (I.Index.prototype.query = function(e) {
          ...
          for (a = 0; a < t.clauses.length; a++) {
                ...
                for (y = 0; y < u.fields.length; y++) {
                  ...
                  if (
                    (u.presence == I.Query.presence.REQUIRED &&
                      ((c = c.union(b)),
                      void 0 === s[j] && (s[j] = I.Set.complete)),
                    u.presence != I.Query.presence.PROHIBITED)
                  ) {
                    if (
                      (n[j].upsert(v, u.boost, function(e, t) {
                        return e + t;
                      }),
                      !i[S])
                    ) {
                      for (var k = 0; k < Q.length; k++) {
                        var E,
                          L = Q[k],
                          P = new I.FieldRef(L, j),
                          T = w[L];
                        void 0 === (E = r[P])
                          ? (r[P] = new I.MatchData(g, j, T))
                          : E.add(g, j, T);
                      }
                      i[S] = !0;
                    }
                  } else
                    void 0 === o[j] && (o[j] = I.Set.empty),
                      (o[j] = o[j].union(b));
                }
              }
            }
            if (u.presence === I.Query.presence.REQUIRED)
              for (y = 0; y < u.fields.length; y++) {
                s[(j = u.fields[y])] = s[j].intersect(c);
              }
          }
          var O = I.Set.complete,
            R = I.Set.empty;
          for (a = 0; a < this.fields.length; a++) {
            var j;
            s[(j = this.fields[a])] && (O = O.intersect(s[j])),
              o[j] && (R = R.union(o[j]));
          }
          var F = Object.keys(r),
            C = [],
          ...
          for (a = 0; a < F.length; a++) {
            var D = (N = I.FieldRef.fromString(F[a])).docRef;
            if (O.contains(D) && !R.contains(D)) {
              var A,
                B = this.fieldVectors[N],
                $ = n[N.fieldName].similarity(B);
              if (void 0 !== (A = _[D]))
                (A.score += $), A.matchData.combine(r[N]);
              else {
                var z = { ref: D, score: $, matchData: r[N] };
                (_[D] = z), C.push(z);
              }
            }
          }
        ...
        (I.Builder.prototype.createFieldVectors = function() {
          for (
            ...
            for (
              ...
              void 0 === n[x]
                ? ((y = I.idf(this.invertedIndex[x], this.documentCount)),
                  (n[x] = y))
                : (y = n[x]),
                (m =
                  (y * ((this._k1 + 1) * v)) /
            ...
            switch (t.type) {
              ...
              default:
                ...
                throw (t.str.length >= 1 &&
                  (r += " with value '" + t.str + "'"),
                new I.QueryParseError(r, t.start, t.end));
            }
        }),
  ...
  function(e, t, r) {
    ...
    var i,
      s = r(0);
    class o {
      constructor({ config: e, docs: t, pipeline: r, index: n }) {
        (this.documents = (function(e) {
          const t = new Map(),
            r = new Set();
          for (const n of e) {
            const [e, i] = n.location.split("#"),
              o = n.location,
              a = n.title,
              u = s(n.text)
                .replace(/\s+(?=[,.:;!?])/g, "")
            ...
            if (i) {
              const i = t.get(e);
              r.has(i)
                ? t.set(o, { location: o, title: a, text: u, parent: i })
                : ((i.title = n.title), (i.text = u), r.add(i));
            } else t.set(o, { location: o, title: a, text: u });
          }
          return t;
        })(t)),
          (this.highlight = (function(e) {
            const t = new RegExp(e.separator, "img"),
              r = (e, t, r) => `${t}<mark data-md-highlight>${r}</mark>`;
            return (n) => {
              ...
              return (e) =>
                e.replace(i, r).replace(/<\/mark>(\s+)<mark[^>]*>/gim, "$1");
            };
          })(e)),
            ...
            void 0 === n
              ? lunr(function() {
                  1 === e.lang.length && "en" !== e.lang[0]
                    ...
                    : e.lang.length > 1 &&
                      this.use(lunr.multiLanguage(...e.lang));
                  const n = (function(e, t) {
                    const [r, n] = [new Set(e), new Set(t)];
                    return [...new Set([...r].filter((e) => !n.has(e)))];
                  })(["trimmer", "stopWordFilter", "stemmer"], r);
                  for (const t of e.lang.map((e) =>
                    "en" === e ? lunr : lunr[e]
                  ))
                    for (const e of n)
                      this.pipeline.remove(t[e]),
                        this.searchPipeline.remove(t[e]);
      ...
      search(e) {
        if (e)
          try {
            const t = this.highlight(e),
              r = (function(e) {
                const t = new lunr.Query(["title", "text"]);
                return new lunr.QueryParser(e, t).parse(), t.clauses;
              })(e).filter(
                (e) => e.presence !== lunr.Query.presence.PROHIBITED
              );
            return [
              ...this.index
                .search(e + "*")
                .reduce((e, { ref: n, score: i, matchData: s }) => {
                  const o = this.documents.get(n);
                  if (void 0 !== o) {
                    const { location: n, title: a, text: u, parent: l } = o,
                      c = (function(e, t) {
                        const r = new Set(e),
                          n = {};
                        for (let e = 0; e < t.length; e++)
                          for (const i of r)
                            t[e].startsWith(i.term) &&
                              ((n[i.term] = !0), r.delete(i));
                        for (const e of r) n[e.term] = !1;
                        return n;
                      })(r, Object.keys(s.metadata)),
                      h = +!l + +Object.values(c).every((e) => e);
                    e.push({
                      location: n,
                      title: t(a),
                      text: t(u),
                ...
                .reduce((e, t) => {
                  const r = this.documents.get(t.location);
                  if (void 0 !== r) {
                    const n = "parent" in r ? r.parent.location : r.location;
                    e.set(n, [...(e.get(n) || []), t]);
                  }
                  return e;
                }, new Map())
    ...
    function u(e) {
      return n(this, void 0, void 0, function*() {
        switch (e.type) {
              ...
              yield (function(e) {
                return n(this, void 0, void 0, function*() {
                  ...
                  if (
                    ...
                    "IFrameWorker" in parent
                  ) {
                    const e = document.querySelector("script[src]"),
                      [r] = e.src.split("/worker");
                    t = t.replace("..", r);
                  }
                  const r = [];
                  for (const n of e.lang)
                    "ja" === n && r.push(t + "/tinyseg.min.js"),
                      "en" !== n && r.push(`${t}/min/lunr.${n}.min.js`);
                  e.lang.length > 1 && r.push(t + "/min/lunr.multi.min.js"),
                    r.length &&
                      (yield importScripts(
                        t + "/min/lunr.stemmer.support.min.js",
                        ...r
                      ));
                });
              })(e.data.config),
          ...
          case i.QUERY:
            return { type: i.RESULT, data: a ? a.search(e.data) : [] };
          default:
